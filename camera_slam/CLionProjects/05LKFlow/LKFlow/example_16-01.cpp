...
//    }
    ...
    // results.
    //
    cv::Mat imgA = cv::imread("../1.png", CV_LOAD_IMAGE_GRAYSCALE);
    cv::Mat imgB = cv::imread("../2.png", CV_LOAD_IMAGE_GRAYSCALE);
    cv::Size img_sz = imgA.size();
    int win_size = 10;
    cv::Mat imgC = cv::imread("../2.png", CV_LOAD_IMAGE_UNCHANGED);
