...
int main( int argc, char** argv )
{
    ...
    // 所有的关键帧都放在了这里
    vector< FRAME > keyframes;// 存放关键帧的vector
    // initialize
    ...
    *******************************/
    ...
    for ( currIndex=startIndex+1; currIndex<endIndex; currIndex++ )
    {
        ...
        case TOO_FAR_AWAY:
            // 太近了，也直接跳
            cout<<RED"Too far away, may be an error."<<endl; // 红色为出错
            break;
        case TOO_CLOSE:
            // 太远了，可能出错了
            ...
            break;
        case KEYFRAME:
            cout<<GREEN"This is a new keyframe"<<endl; // 绿色信息则是添加新的关键帧
            // 不远不近，刚好
            /**
             * This is important!!
             * This is important!!
...
CHECK_RESULT checkKeyframes( FRAME& f1, FRAME& f2, g2o::SparseOptimizer& opti, bool is_loops)
{
    ...
    // 回环检测是很怕"false positive"的，即“将实际上不同的地方当成了同一处”，
    // 这会导致地图出现明显的不一致。
    // 所以，在使用g2o时，要在边里添加"robust kernel"，
    // 保证一两个错误的边不会影响整体结果。
