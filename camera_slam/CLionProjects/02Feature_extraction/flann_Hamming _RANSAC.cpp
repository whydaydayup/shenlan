...
//    FlannBasedMatcher matcher;
    //cv::Ptr<cv::DescriptorMatcher> matcher = cv::makePtr<cv::FlannBasedMatcher>(cv::makePtr<cv::flann::LshIndexParams>(5, 10, 2));
    FlannBasedMatcher matcher(new cv::flann::LshIndexParams(5, 10, 1));
    boost::timer timer;
